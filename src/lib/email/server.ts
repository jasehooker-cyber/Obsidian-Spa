...
<body style="margin:0;padding:0;background:#131009;font-family:Arial,Helvetica,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background:#17120c;border:1px solid #2e261a;border-top:none;padding:24px 32px;">
      ...
      <ul style="color:#a89c8a;font-size:13px;line-height:1.8;margin:0;padding-left:20px;">
        <li><strong style="color:#f2ede3;">Cancelling within ${BUSINESS.fees.lateCancelWindowMinutes} minutes</strong> of your start time: ${formatPrice(BUSINESS.fees.lateCancelFee)} fee</li>
    ...
    <div style="text-align:center;margin-top:32px;">
      ...
      <p style="color:#6f675c;font-size:11px;line-height:1.6;margin:12px 0 0;">
        ${FULL_ADDRESS}<br>
  ...
  const text = [
    ...
    `Cancelling within ${BUSINESS.fees.lateCancelWindowMinutes} minutes of your start time: ${formatPrice(BUSINESS.fees.lateCancelFee)} fee.`,
...
<body style="margin:0;padding:0;background:#131009;font-family:Arial,Helvetica,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="background:#1d1710;border:1px solid #2e261a;padding:32px;">
      <h2 style="color:#f2ede3;font-size:20px;margin:0 0 8px;">Almost there, ${firstName}.</h2>
      <p style="color:#a89c8a;font-size:14px;line-height:1.6;margin:0 0 20px;">
        We're holding <strong style="color:#f2ede3;">${date} at ${time} ET</strong> for you.
        To secure it, add a card to your file — you will
        <strong style="color:#f2ede3;">not be charged now</strong>.
      </p>

      <div style="text-align:center;margin:28px 0;">
        <a href="${params.payUrl}" style="display:inline-block;background:#bb9159;color:#131009;padding:14px 32px;font-size:14px;font-weight:600;letter-spacing:2px;text-decoration:none;">
          SECURE MY BOOKING
        </a>
      </div>
    ...
    <div style="background:#17120c;border:1px solid #2e261a;border-top:none;padding:24px 32px;">
      <h3 style="color:#bb9159;font-size:13px;letter-spacing:2px;margin:0 0 12px;">WHY WE NEED A CARD</h3>
      <p style="color:#a89c8a;font-size:13px;line-height:1.6;margin:0 0 8px;">
